...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -743244132;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        78 => wire__crate__api__drafts__load_draft_impl(port, ptr, rust_vec_len, data_len),
        79 => wire__crate__api__accounts__login_cancel_impl(port, ptr, rust_vec_len, data_len),
        80 => wire__crate__api__signer__login_external_signer_publish_default_relays_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        81 => wire__crate__api__signer__login_external_signer_start_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        82 => wire__crate__api__signer__login_external_signer_with_custom_relay_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        83 => wire__crate__api__accounts__login_publish_default_relays_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        84 => wire__crate__api__accounts__login_start_impl(port, ptr, rust_vec_len, data_len),
        85 => wire__crate__api__accounts__login_with_custom_relay_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        86 => wire__crate__api__accounts__logout_impl(port, ptr, rust_vec_len, data_len),
        87 => wire__crate__api__account_groups__mark_message_read_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        88 => wire__crate__api__chat_list__mute_chat_impl(port, ptr, rust_vec_len, data_len),
        90 => wire__crate__api__accounts__publish_account_key_package_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        91 => wire__crate__api__signer__register_external_signer_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        92 => wire__crate__api__relays__relay_type_inbox_impl(port, ptr, rust_vec_len, data_len),
        93 => {
            wire__crate__api__relays__relay_type_key_package_impl(port, ptr, rust_vec_len, data_len)
        }
        94 => wire__crate__api__relays__relay_type_nip65_impl(port, ptr, rust_vec_len, data_len),
        95 => {
        ...
        97 => wire__crate__api__groups__remove_members_from_group_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        98 => wire__crate__api__accounts__restore_default_relays_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        99 => wire__crate__api__messages__retry_message_publish_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        100 => wire__crate__api__drafts__save_draft_impl(port, ptr, rust_vec_len, data_len),
        101 => wire__crate__api__messages__search_messages_impl(port, ptr, rust_vec_len, data_len),
        102 => wire__crate__api__messages__search_messages_in_group_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        103 => wire__crate__api__user_search__search_users_impl(port, ptr, rust_vec_len, data_len),
        104 => {
            wire__crate__api__bug_report__send_bug_report_impl(port, ptr, rust_vec_len, data_len)
        }
        105 => wire__crate__api__messages__send_message_to_group_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        108 => wire__crate__api__chat_list__subscribe_to_archived_chat_list_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        109 => wire__crate__api__chat_list__subscribe_to_chat_list_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        110 => wire__crate__api__messages__subscribe_to_group_messages_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        111 => wire__crate__api__notifications__subscribe_to_notifications_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        113 => wire__crate__api__users__subscribe_to_user_impl(port, ptr, rust_vec_len, data_len),
        114 => wire__crate__api__utils__tag_from_vec_impl(port, ptr, rust_vec_len, data_len),
        119 => {
            wire__crate__api__account_groups__unarchive_chat_impl(port, ptr, rust_vec_len, data_len)
        }
        120 => wire__crate__api__mute_list__unblock_user_impl(port, ptr, rust_vec_len, data_len),
        121 => wire__crate__api__accounts__unfollow_user_impl(port, ptr, rust_vec_len, data_len),
        122 => wire__crate__api__chat_list__unmute_chat_impl(port, ptr, rust_vec_len, data_len),
        123 => wire__crate__api__accounts__update_account_metadata_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        124 => wire__crate__api__update_language_impl(port, ptr, rust_vec_len, data_len),
        125 => wire__crate__api__accounts__update_notifications_enabled_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        126 => wire__crate__api__update_theme_mode_impl(port, ptr, rust_vec_len, data_len),
        127 => wire__crate__api__accounts__upload_account_profile_picture_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        129 => wire__crate__api__groups__upload_group_image_impl(port, ptr, rust_vec_len, data_len),
        130 => wire__crate__api__notifications__upsert_push_registration_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        132 => wire__crate__api__users__user_metadata_impl(port, ptr, rust_vec_len, data_len),
        133 => wire__crate__api__users__user_relays_impl(port, ptr, rust_vec_len, data_len),
        134 => wire__crate__api__groups__visible_groups_with_info_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        89 => wire__crate__api__utils__npub_from_hex_pubkey_impl(ptr, rust_vec_len, data_len),
        115 => wire__crate__api__utils__theme_mode_dark_impl(ptr, rust_vec_len, data_len),
        116 => wire__crate__api__utils__theme_mode_light_impl(ptr, rust_vec_len, data_len),
        117 => wire__crate__api__utils__theme_mode_system_impl(ptr, rust_vec_len, data_len),
        118 => wire__crate__api__utils__theme_mode_to_string_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
